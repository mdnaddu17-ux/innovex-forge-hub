...
/**
 * A type representing the database reader context.
 */
export type QueryCtx = GenericQueryCtx<DataModel>;

/**
 * A type representing the database writer context.
 */
export type MutationCtx = GenericMutationCtx<DataModel>;

/**
 * A type representing the action context.
 */
export type ActionCtx = GenericActionCtx<DataModel>;

/**
 * A type representing the database reader.
 */
export type DatabaseReader = GenericDatabaseReader<DataModel>;

/**
 * A type representing the database writer.
 */
